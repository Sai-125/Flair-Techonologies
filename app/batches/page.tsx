        ...
        <div className="container mx-auto px-4">
          ...
          >
            <Badge className="mb-4 bg-cyan-100 text-cyan-700">
              {batchesSection.badge}
            </Badge>
            <h2
              className="text-4xl font-bold text-gray-900 mb-4"
              dangerouslySetInnerHTML={{ __html: batchesSection.title }}
            />
            <p className="text-gray-600 max-w-2xl mx-auto text-lg">
              {batchesSection.description}
            </p>
          </motion.div>
                ...
                <Card className="border-0 shadow-xl hover:shadow-2xl transition-all duration-300 h-full bg-white/90 backdrop-blur-sm group hover:-translate-y-2">
                  <CardHeader className="pb-4">
                    <div className="flex items-start gap-4">
                      <div
                        className={`w-16 h-16 ${batch.iconBg} rounded-2xl flex items-center justify-center text-white text-2xl flex-shrink-0 group-hover:scale-110 transition-transform duration-300`}
                      >
                        {batch.icon}
                      </div>
      ...
      <section className="py-20 bg-gradient-to-br from-cyan-50 to-blue-50">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <h2
              className="text-4xl font-bold text-gray-900 mb-4"
              dangerouslySetInnerHTML={{ __html: whyChooseUsSection.title }}
            />
          </motion.div>
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              {ctaSection.buttons.map((button, index) => (
                <Button key={index} size="lg" className={button.className}>
                  {button.text}
                </Button>
              ))}
            </div>
