        ...
        <form className="space-y-4 ">
          ...
          <div>
            ...
            <select className="w-full px-4 py-2 rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-sky-500">
              ...
              <option value="Development">Development Courses</option>
              <option value="Cloud">Analytics Courses</option>
              <option value="Networking">Networking Courses</option>
              <option value="Finance">Finance Course</option>
              <option value="AI & ML">AI & ML Course</option>
              <option value="Testing">Freshers Program</option>
              <option value="Freshers">Freshers Program</option>
